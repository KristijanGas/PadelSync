...
(
  ...
  terenID INTEGER PRIMARY KEY AUTOINCREMENT,
...
(
  ...
  FOREIGN KEY (username) REFERENCES IGRAC(username) ON DELETE CASCADE,
...
(
  ...
  fotoTerenID INTEGER PRIMARY KEY AUTOINCREMENT,
